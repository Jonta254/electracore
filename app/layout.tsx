...
export const metadata: Metadata = {
  ...
  description: "The complete electrical platform for students, engineers, and trade workers. Circuit calculators, wiring guides, learning paths, load analysis, and project tools — built by an electrician with 8 years on the tools.",
